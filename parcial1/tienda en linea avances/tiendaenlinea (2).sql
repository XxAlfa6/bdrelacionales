...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-03-2025 a las 01:01:11
...
(1, 'chavita', 10, 'alexander', 20232, 'california', 'africa', 1);
...
(1, 'chocolate', 'pan relleno de chocolate', 15, 1, 1);
...
(1, 'Rosselyn', 'Esparza Uriarte', 'rosselyn.esparza23@cetis107.edu.mx', '6674033254', '2008-12-20', 1);
...
ALTER TABLE `lista_deseo`
  ...
  ADD CONSTRAINT `lista_deseo_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`);
