...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-03-2025 a las 02:31:11
...
--
-- Estructura de tabla para la tabla `favoritos_1`
--

CREATE TABLE `favoritos_1` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `favoritos_1`
--

INSERT INTO `favoritos_1` (`id`, `usuario_id`, `canciones_id`) VALUES
(1, 4, 39),
(2, 5, 17),
(3, 6, 34),
(4, 8, 21),
...
--
-- Estructura de tabla para la tabla `playlistcanciones_2`
--

CREATE TABLE `playlistcanciones_2` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `playlistcanciones_2`
--

INSERT INTO `playlistcanciones_2` (`id`, `playlist_id`, `canciones_id`, `usuario_id`) VALUES
(1, 1, 39, 4),
(2, 1, 8, 4),
(3, 1, 17, 4),
(4, 2, 11, 5),
...
(5, 'Viajes', 3, '10:00:00', 121, 'Para cuando salgamos de viaje', 1);
...
--
-- Indices de la tabla `favoritos_1`
--
ALTER TABLE `favoritos_1`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `playlistcanciones_2`
--
ALTER TABLE `playlistcanciones_2`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT de la tabla `favoritos_1`
--
ALTER TABLE `favoritos_1`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- AUTO_INCREMENT de la tabla `playlistcanciones_2`
--
ALTER TABLE `playlistcanciones_2`
...
--
-- Filtros para la tabla `favoritos_1`
--
ALTER TABLE `favoritos_1`
  ADD CONSTRAINT `favoritos_1_ibfk_1` FOREIGN KEY (`canciones_id`) REFERENCES `canciones` (`id`),
  ADD CONSTRAINT `favoritos_1_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios_1` (`id`);

--
-- Filtros para la tabla `playlistcanciones_2`
--
ALTER TABLE `playlistcanciones_2`
  ADD CONSTRAINT `playlistcanciones_2_ibfk_1` FOREIGN KEY (`canciones_id`) REFERENCES `canciones` (`id`),
  ADD CONSTRAINT `playlistcanciones_2_ibfk_2` FOREIGN KEY (`playlist_id`) REFERENCES `playlist_1` (`id`),
  ADD CONSTRAINT `playlistcanciones_2_ibfk_3` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios_1` (`id`);
